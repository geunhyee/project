package com.exchange.pp.board.web;
...
import com.exchange.pp.board.service.BoardService;
...
public class BoardController {
	 ...
	 * 
	 * @ModelAttribute("comList") //comList로 board쪽에서는 모두 사용가능 public List<CodeVO>
	 * getCodeList(){ List<CodeVO> comList = codeService.getCodeList(null); return
	 * comList; }
	 */
